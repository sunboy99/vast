...
# https://raw.githubusercontent.com/sunboy99/vast/main/flux1outpaint.sh

# Packages are installed after nodes so we can fix them...

DEFAULT_WORKFLOW="https://raw.githubusercontent.com/sunboy99/vast/main/flux1outpaint.json"
